...
class Food(models.Model):
	...
	cholesterol = models.FloatField(verbose_name="Cholesterol (mg)", default = 0.00)
	sodium = models.FloatField(verbose_name="Sodium (mg)", default = 0.00)
	total_carbohydrate = models.FloatField(verbose_name="Total Carbohydrate (g)", default = 0.00)
	dietary_fibre = models.FloatField(verbose_name="Dietary Fibre (g)", default = 0.00)
	sugar = models.FloatField(verbose_name="Sugar (g)", default = 0.00)
	protein = models.FloatField(verbose_name="Protein (g)", default = 0.00)
